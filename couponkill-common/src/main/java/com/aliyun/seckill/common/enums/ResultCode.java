...
/**
 * @deprecated Phase3 起对外错误码统一为 {@link com.aliyun.seckill.common.api.ErrorCodes}。
 * 本枚举仅兼容历史 {@code Result}/旧调用，禁止新代码使用。
 */
@Deprecated
@Getter
@AllArgsConstructor
public enum ResultCode {
    ...
    SECKILL_USE_DEDICATED_API(9004, "秒杀券请使用 /api/v1/order/seckill 接口"),
